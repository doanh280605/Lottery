    ...
    try {
      ...
      if (contentType && contentType.includes('application/json')) {
        ...
        if (responseData && Array.isArray(responseData)) {
          const allNumbers = responseData.flatMap(item => item.resultNumbers.map(num => parseInt(num, 10)));
          const frequencyMap = {};
          ...
          const leastFrequentNumbers = Object.entries(frequencyMap)
