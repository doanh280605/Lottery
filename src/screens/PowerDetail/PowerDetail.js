            ...
            <View style={styles.container}>
                <View style={styles.ticketContainer}>
                    ...
                    <View style={styles.latestNumbersContainer}>
                        ...
                        <View style={[styles.latestBall, styles.specialBall]}>
                            <Text style={styles.latestBallText}>
                                {result.specialNumber.toString().padStart(2, '0')}
                            </Text>
                        </View>
                    </View>
                </View>
                ...
                <View style={styles.prizeTable}>
                    ...
                    <View style={[styles.prizeRow, styles.whiteRow]}>
                        ...
                        <Text style={[styles.prizeValue, { flex: 4 }]}>{result.jackpot1Value}</Text>
                    </View>
                    ...
                    <View style={[styles.prizeRow, styles.whiteRow]}>
                        ...
                        <Text style={[styles.prizeValue, { flex: 4 }]}>{result.jackpot2Value}</Text>
                    </View>
                        ...
                        >
                            <View style={styles.olderTicketContainer}>
                                ...
                                <View style={styles.olderNumbersContainer}>
                                    {Array.isArray(ticket.numbers) && ticket.numbers.map((number, index) => (
                                    ...
                                    {ticket?.specialNumber !== undefined && (
                                        <View style={[styles.olderBall, styles.olderSpecialBall]}>
                                        <Text style={styles.olderBallText}>
                                            {ticket.specialNumber?.toString().padStart(2, '0') || '00'}
                                        </Text>
                                        </View>
                                    )}
                                </View>
